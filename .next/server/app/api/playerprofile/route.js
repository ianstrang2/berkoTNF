"use strict";(()=>{var e={};e.id=823,e.ids=[823],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},9060:(e,a,t)=>{t.r(a),t.d(a,{originalPathname:()=>E,patchFetch:()=>N,requestAsyncStorage:()=>o,routeModule:()=>l,serverHooks:()=>u,staticGenerationAsyncStorage:()=>i});var s={};t.r(s),t.d(s,{GET:()=>d});var r=t(9303),p=t(8716),_=t(670),n=t(7070),m=t(728);async function d(e){try{console.log("Fetching player profile...");let{searchParams:a}=new URL(e.url),t=a.get("id");if(!t)return console.error("Error: No ID provided in request"),n.NextResponse.json({error:"No ID provided"},{status:400});let s=parseInt(t,10);console.log("Fetching profile for ID:",s);let r=await m._.$queryRaw`
      WITH 
        player_stats AS (
          SELECT 
            p.player_id,
