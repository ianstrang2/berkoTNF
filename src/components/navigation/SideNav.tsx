...
export default function SideNav() {
  ...
  const { expandedSection } = useNavigation();
  ...
  return (
    <div className={`hidden md:flex fixed left-0 top-0 h-full bg-white shadow-sm z-40 flex-col transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-56'}`}>
      ...
      <div className="flex-grow py-6">
        ...
        {expandedSection === 'more' && !isCollapsed && (
          <div className="mt-6 border-t border-neutral-200 pt-4 px-3">
        ...
        {expandedSection === 'admin' && !isCollapsed && (
          <div className="mt-6 border-t border-neutral-200 pt-4 px-3">
            <h3 className="text-xs font-semibold text-neutral-500 uppercase tracking-wider">
              Admin Options
            </h3>
