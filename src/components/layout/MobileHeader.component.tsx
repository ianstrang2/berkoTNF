  ...
  return (
    <>
      ...
      {platform === 'ios' && profile.isAuthenticated && showAuthContent && !profile.isSuperadmin && (
        <button
          onClick={() => setShowMenu(!showMenu)}
          className="fixed right-4 z-50 w-14 h-14 rounded-full bg-gradient-to-tl from-purple-700 to-pink-500 shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center"
