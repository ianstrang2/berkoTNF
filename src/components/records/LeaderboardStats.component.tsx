          ...
          <thead className="align-bottom">
            <tr>
              ...
              <th 
                ...
                className="sticky left-[4.5rem] z-30 px-2 py-3 font-bold uppercase align-middle bg-white border-b border-gray-300 border-solid shadow-none text-xxs tracking-none whitespace-nowrap text-slate-400 opacity-70 cursor-pointer hover:text-slate-700 text-left min-w-[120px]"
              >
