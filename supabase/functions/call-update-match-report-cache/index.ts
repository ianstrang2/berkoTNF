// supabase/functions/call-update-match-report-cache/index.ts
...
const FUNCTION_NAME = 'call-update-match-report-cache';
const TARGET_RPC = 'update_aggregated_match_report_cache'; // Specific RPC for this function
