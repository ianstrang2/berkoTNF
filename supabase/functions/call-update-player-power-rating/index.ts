// supabase/functions/call-update-player-power-rating/index.ts
...
const FUNCTION_NAME = 'call-update-player-power-rating';
const TARGET_RPC = 'update_aggregated_player_power_rating'; // Specific RPC for this function
