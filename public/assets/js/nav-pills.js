...
if (total[0]) {
  total.forEach(function (item, i) {
    ...
    tab.innerHTML = "-";
    tab.classList.remove("bg-inherit", "text-slate-700", "dark:text-white");
    tab.classList.add("bg-white", "text-white", "dark:bg-slate-950", "dark:text-slate-950", "shadow-soft-xxs");
      ...
      if (li) {
        ...
        item.querySelector("li:nth-child(" + index + ") [nav-link]").onclick = function () {
          item.querySelectorAll("li").forEach(function (list_item) {
            list_item.firstElementChild.classList.remove("dark:text-white");
          ...
          li.firstElementChild.classList.add("dark:text-white");
